...
//		public double[][][] Double3DMatrixInstance() {
//			int n_entries = this.DataEntries.Count;
//			double[][][] arr = new double[n_entries][][];
//			for (int i = 0; i < n_entries; i++) {
//				arr [i] = this.DataEntries [i].GetDoubleMatrixRepresentation ();
//			}
//			return arr;
//		}
