...
namespace UCRCSharp
{
    public partial class UCR
    {
      ...
      //  }
        ...
        // Main Function
		public static double DTW(double[] input, double[] query, int queryLength, bool sq_dist_ok, double wrappingWindow = 0)
        {
          ...
          //  FileStream qp = null; //Query File Pointer
			...
			for (int itt = 0; itt < query.Length && i < m; itt++)
            {
